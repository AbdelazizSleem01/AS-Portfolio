...
export async function POST(req) {
  try {
    ...
    const verificationLink = `${process.env.NEXT_PUBLIC_BASE_URL}/api/verify?token=${newSub.verificationToken}`;
          ...
          <tr>
            <td style="padding: 20px; background-color: #f8f9fa; text-align: center;">
              <p style="color: #636e72; font-size: 0.8em; margin: 0;">
                ...
                <a href="${process.env.NEXT_PUBLIC_BASE_URL}/privacy" style="color: #0984e3; text-decoration: none;">Privacy Policy</a> | 
                <a href="${process.env.NEXT_PUBLIC_BASE_URL}/unsubscribe?token=${newSub.unsubscribeToken}" style="color: #0984e3; text-decoration: none;">Unsubscribe</a>
              </p>
            </td>
          </tr>
        </table>
